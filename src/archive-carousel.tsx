    ...
    return (
        <>
            <div className="a-carousel-main">
                <br/>
                <div id="aCarousel" className="carousel slide" data-ride="carousel">
                    ...
                    <div className="carousel-inner a-carousel-container" role="listbox">

                        <div className="item active">
                            <div className="frame1"></div>
                            <div className="frame2">
                                <div className="a-carousel-img">
                                    <img src="/images/c6pos1.png" alt="Drone Website"/>
                                </div>
